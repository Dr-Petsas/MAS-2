...
const _CLASSIFY_SYSTEM = [
  ...
  "  'Zahn 36 kariös', 'Karies mesial okklusal', 'insuffiziente/alte Füllung',",
  "  'Zahn fehlt'). Also: KARIES an einer Flaeche = befund.",
  ...
  "  eingesetzt). Dazu gehoeren die FUELLUNGSFLAECHEN der gelegten Fuellung",
  "  (mesial, okklusal, distal, zervikal, MOD/OD/MO ...) und das Fuellungsmaterial",
  "  (Komposit). Nennt der Arzt beim Fuellen die Flaechen -> therapie.",
  "- WICHTIG Fuellung: Flaechenangaben zu einer GELEGTEN Fuellung/Restauration",
  "  sind therapie (Behandlung). NUR wenn ausdruecklich Karies/kariös an der",
  "  Flaeche ODER eine insuffiziente/alte Fuellung gemeint ist -> befund.",
