...
#
# Laeuft bis Montag, 15.06.2026, 08:00 — danach traegt sich der Task selbst aus.
...
# Endzeit: Montag 15.06.2026 08:00 — danach Task entfernen und beenden.
$ende = Get-Date -Year 2026 -Month 6 -Day 15 -Hour 8 -Minute 0 -Second 0
if ((Get-Date) -gt $ende) {
